...
kable(return_stats, caption = "Table 1: Return Statistics")
```
...
kable(stationarity_results, caption = "Table 1: Stationarity Test Results")
```
...
kable(arch_results, caption = "Table 3: ARCH Effects Test")
```
...
kable(arima_info, caption = "Table 4: Selected ARIMA Model")
...
kable(ljung_box_results, caption = "Table 5: ARIMA Residual Diagnostics")
```
...
kable(garch_params, caption = "Table 6: GARCH(1,1) Model Parameters")
```
...
kable(all_lb_results, caption = "Table 7: Autocorrelation Tests on GARCH Residuals")
```
...
kable(normality_tests, caption = "Table 8: Normality Tests on Standardized Residuals")
```
...
kable(arch_test_result, caption = "Table 9: Test for Remaining ARCH Effects")
```
...
kable(multiple_testing_results, caption = "Table 10: Multiple Testing Correction")
```
...
kable(effect_sizes, caption = "Table 11: Effect Size Measures for Standardized Residuals")
```
